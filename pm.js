...
function pm(e) {
  ...
  function i() {
    ...
    return localStorage.setItem("MMdevice", e), e;
  }
  function n() {
  ...
  !(function e(i) {
    ...
    switch (i.type) {
      ...
      case "remove_product":
        ...
        break;
      case "add_product":
        (y = i), (w = I), (w.type = "add_product"), (w.items = y.items), gf(w);
        break;
      case "view_product":
        (k = i), (b = I), (b.type = "view_product"), (b.items = k.items), gf(b);
        break;
      case "page_view":
        !(function e(i, n) {
          let s = r();
          if (!s) {
            s = (function e() {
              let i = "SE-" + t();
              return sessionStorage.setItem("MMPsessionId", i), i;
            })();
            let o = (function e() {
              let i = t(),
                n = "P-" + i + "-" + Date.now();
              return sessionStorage.setItem("MMhash", i), n;
            })();
