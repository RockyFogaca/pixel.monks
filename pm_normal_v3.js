    ...
    function Iniciar(eventObject) {
        ...
        switch (eventObject.type) {
            ...
            case 'purchase':
                ...
                BANNER_DATA_MANAGER.assignBannersToItems(eventObject.items, {deleteBannersData: true});
            ...
            case 'view_banner':
                ...
                eventObjectLocal.items = [{ 'banners': eventObject.bannerData }];
...
function bannerDataManager() {
    ...
    var saveViewedItem = function saveViewedItem(itemsArr, pageUrl) {
        ...
        promoObj = libLS.getItem(keyLS) || {};
        itemsList = promoObj[pageUrl] && promoObj[pageUrl].items ? promoObj[pageUrl].items : {};
    ...
    var assignBannersToItems = function assignBannersToItems(items, {deleteBannersData = false}) {
